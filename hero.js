const TOP_IMAGE = "./assets/portrait_top.JPG";
const BOTTOM_IMAGE = "./assets/portrait_bottom.PNG";
...
function init() {
  ...
  loadImage(TOP_IMAGE, topTexture, topTextureSize);
  loadImage(BOTTOM_IMAGE, bottomTexture, bottomTextureSize);
