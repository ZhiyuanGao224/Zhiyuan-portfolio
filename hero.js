...
const ASSET_BASE = new URL("./assets/", SCRIPT_URL);
const TOP_IMAGE = new URL("portrait_top.JPG", ASSET_BASE).href;
const BOTTOM_IMAGE = new URL("portrait_bottom.PNG", ASSET_BASE).href;
...
loadImage(TOP_IMAGE, topTextureSize, "top");
loadImage(BOTTOM_IMAGE, bottomTextureSize, "bottom");
...
function loadImage(url, textureSizeVector, type) {
  const img = new Image();
